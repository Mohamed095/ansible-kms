...
EXAMPLE OF URL:
#url: "http://172.30.10.169:8081/service/rest/v1/search?repository=dyco-raw&group=/elasticsearch/bin/5.4.0"
...
def get_checksum(raw,repo,option,version,address,port,hash_type):
